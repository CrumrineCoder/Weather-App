...
app.controller('weatherController', function ($scope) {
	...
	$scope.callByIP = function (position) {
		...
		$.getJSON(GEOCODING, function (json) {
			if (json.status == "OVER_QUERY_LIMIT") {
				alert("Unfortunately, the API has run over its query limit for the day. Backup random data has been provided.");
	...
	var phrases = ["Do you  want to use this website or not?", "Fine, we'll just sit here until you're ready to cooperate.", "You can check the Github. There is no database. https://github.com/CrumrineCoder/Weather-App.", "Are you some sort of rebel?", "Rebel Rebel, you've torn your dress. Rebel Rebel, your face is a mess. Rebel Rebel, how could they know?", "Are you just going to sit through here and see all the funny clown jokes I made?", "I’m funny how? I mean funny, like I’m a clown? I amuse you? I make you laugh? I’m here to amuse you? Whattya you mean funny? Funny how? How am I funny?", "Look, will you just click accept so you can use my website? This is just some stupid joke I put in and it took me like 5 minutes to set up. The rest of the site took much longer.", "FINE, GO AHEAD. I WON'T SAY ANY MORE JOKES. GO STICK YOUR HEAD OUT OF THE WINDOW TO GET THE WEATHER, SEE IF I CARE.", "I'm sorry, we left off on the wrong foot. Just. Click. Allow.", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", "I've run out of ideas for jokes. Just click allow or whatever I don't care.", "Filler", "Filler 1", "Filler 2", "Filler 3", "Filler 4", "Filler 5", "Filler 100", "Filler 7", "LOOK IF YOU WANT TO SEE ALL THE JOKES YOU CAN GO ON GITHUB AND LOOK AT THE DATA.JS FILE. JUST CLICK ALLOW.", "Fine, you found the easter egg. http://www.petwave.com/-/media/Images/Center/Care-and-Nutrition/Dog/Puppy/Puppies-in-Basket.ashx. You did it. Good for you. NOW CLICK ALLOW ALREADY.", "Aha, very clever, you saw through my ruse. Here's the REAL easter egg: https://static.independent.co.uk/s3fs-public/thumbnails/image/2014/09/05/15/terry-pratchett.jpg", "There's no more easter eggs.", "Incredible, you saw through my other ruses. Well, here is. You won. Here's your victory music: https://www.youtube.com/watch?v=Cf7jFBXxL2g", "Ok we're actually done. It's going to loop around. I hope you enjoyed this rollercoaster of emotions."]
	var phrasesIndex = 0;
